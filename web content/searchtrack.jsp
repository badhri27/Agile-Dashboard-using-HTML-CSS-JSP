		...
		<div class="row display-row-table container-fluid">
			<div
				...
				<div class="navi">
					...
					<ul>
						...
						<li class="active"><a href="searchtrack.jsp"><i class="fa fa-info-circle"
			...
			<div class="col-sm-10 display-table-cell v-align">
				<div class="user-dashboard" style="font-family: 'Manrope', sans-serif;">
					<div>
						<div class="navbar-header" style="font-family: 'Manrope', sans-serif;">
							<br>
							<h2 style="text-align:center;font-weight:bold;">Tracker page</h2>
						...
						<div class="container">
							...
							<div class="search hidden-xs hidden-sm">
								...
								<input type="text" placeholder="Search" name="search-name" id="search" style="font-weight:bold"><br><br>
